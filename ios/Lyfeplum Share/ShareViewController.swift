...
class ShareViewController: SLComposeServiceViewController {
  ...
  let hostAppBundleIdentifier = "com.lyfeplum"
   let shareProtocol = "com.lyfeplum" //share url protocol (must be unique to your app, suggest using your apple bundle id, ie: `hostAppBundleIdentifier`)
